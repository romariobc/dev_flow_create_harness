...
- Nunca enviar dado pessoal sensível identificável (saúde, financeiro, biométrico, de menor etc.) a um modelo em nuvem sem anonimização prévia (ver `dados-sensiveis-por-dominio.md`).
